...
public class TDEnemy : Pathfinding
{
    ...
    // for storing enemies in tower's dictionaries
    //TDManager managerScript;

    void Start () {
        //GameObject gameplayObject = GameObject.Find("GameplayManager");
        //managerScript = (TDManager)gameplayObject.GetComponent("TDManager");
    }
